...
public void swaptopainter() {
        ...
        Fragment fragmentPainter = new Painter();
        fragmentTransaction.replace(R.id.contentframe,fragmentPainter);
    ...
    public void swaptoplumber(){
        Fragment fragmentPlumber=new Plumber();
        FragmentTransaction fragmentTransaction=getFragmentManager().beginTransaction();
        fragmentTransaction.replace(R.id.contentframe,fragmentPlumber);
        fragmentTransaction.addToBackStack(null);
        fragmentTransaction.commit();
    ...
    public void swaptomechanic(){
        Fragment fragmentMechanic=new Mechanic();
        FragmentTransaction fragmentTransaction=getFragmentManager().beginTransaction();
        fragmentTransaction.replace(R.id.contentframe,fragmentMechanic);
        fragmentTransaction.addToBackStack(null);
        fragmentTransaction.commit();
