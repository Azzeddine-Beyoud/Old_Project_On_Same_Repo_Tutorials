...
public class ListPerson {
    ...
    public ListPerson(String name, String lastname, String phonenumber, String city,int id) {
        this.name = name;
    ...
    public ListPerson(String email, String password, String name, String phonenumber, String city) {
        this.email = email;
