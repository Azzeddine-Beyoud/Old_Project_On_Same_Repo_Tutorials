...
String name,lastname,phonenumber,city=null;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Searchadapter=new myCustomAdapter(SearchItems,getActivity().getApplicationContext(),getFragmentManager());
        ...
        SearchItems.add(new ListPerson(DATA.get(j).name, DATA.get(j).Lastname, DATA.get(j).Phonenumber, DATA.get(j).city,DATA.get(j).id));
